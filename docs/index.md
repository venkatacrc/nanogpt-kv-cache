...
description: KV Cache, FlashAttention, GQA, FP8, and Tensor Parallelism — benchmarked on NVIDIA H100 (2×H100 for Tensor Parallelism).
---
...
<!--
  POST OUTLINE — see _outline.md for the section-by-section coaching notes
...
*[draft — see _outline.md §8.4]*

![Naive FP8 attention is slower AND wrong](plots/fp8.png)

## 9. What we learned

*[draft section 9 here — see _outline.md §9]*
